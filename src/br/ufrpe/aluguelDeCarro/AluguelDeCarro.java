...
//            FachadaGerente.getInstance().getUsuarioNegocio().cadastrar(gerente);
//            FachadaGerente.getInstance().setUsuarioLogado(gerente);
//
...
//            FachadaGerente.getInstance().getCarroNegocio().cadastrar(carro, (Gerente) FachadaGerente.getInstance().getUsuarioLogado());
//
